...
describe('helper-wrap-element', () => {
  it('wraps the elements based on their char position which is specified in the kewords map', () => {
    ...
    const expected = 'foo <a class="ghl-link"><span>foo</span></a> <a class="ghl-link"><span>foo</span></a>';
    const keywords = {
      4: 'foo',
      8: 'foo',
    };
  ...
  it('wraps the element just once', () => {
    ...
    const expected = 'foo <a class="ghl-link"><span>foo</span></a>';
    const keywords = {
      4: 'foo',
      8: 'foo',
    };
  ...
  it('adds the cssClass for the debug mode', () => {
    const input = 'foo <span>foo</span>';
    const expected = 'foo <a class="ghl-link ghl-link--debug-mode"><span>foo</span></a>';
    const keywords = {
      4: 'foo',
    };
